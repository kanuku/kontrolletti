...
Aggregates and unifies information from different Source Control Management for historical and auditing purposes and provides a REST API where this information can be retrieved.
